...
public final class Tuple10<A,B,C,D,E,F,G,H,I,J>
    ...
    public static <A,B,C,D,E,F,G,H,I,J> Tuple10<A,B,C,D,E,F,G,H,I,J> with(final A value0, final B value1, final C value2, final D value3, final E value4, final F value5, final G value6, final H value7, final I value8, final J value9) {
        return new Tuple10<A,B,C,D,E,F,G,H,I,J>(value0,value1,value2,value3,value4,value5,value6,value7,value8,value9);
    }
     ...
     * @return the tuple
     */
    public static <X> Tuple10<X,X,X,X,X,X,X,X,X,X> fromCollection(final Collection<X> collection) {
     ...
     * @return the tuple
     */
    public static <X> Tuple10<X,X,X,X,X,X,X,X,X,X> fromIterable(final Iterable<X> iterable, int index) {
        return fromIterable(iterable, index, false);
    }

    
    
    private static <X> Tuple10<X,X,X,X,X,X,X,X,X,X> fromIterable(final Iterable<X> iterable, int index, final boolean exactSize) {
    ...
    public <X> Tuple10<X,B,C,D,E,F,G,H,I,J> setAt0(final X value) {
        return new Tuple10<X,B,C,D,E,F,G,H,I,J>(
                value, this.val1, this.val2, this.val3, this.val4, this.val5, this.val6, this.val7, this.val8, this.val9);
    }
    
    public <X> Tuple10<A,X,C,D,E,F,G,H,I,J> setAt1(final X value) {
        return new Tuple10<A,X,C,D,E,F,G,H,I,J>(
                this.val0, value, this.val2, this.val3, this.val4, this.val5, this.val6, this.val7, this.val8, this.val9);
    }
    
    public <X> Tuple10<A,B,X,D,E,F,G,H,I,J> setAt2(final X value) {
        return new Tuple10<A,B,X,D,E,F,G,H,I,J>(
                this.val0, this.val1, value, this.val3, this.val4, this.val5, this.val6, this.val7, this.val8, this.val9);
    }
    
    public <X> Tuple10<A,B,C,X,E,F,G,H,I,J> setAt3(final X value) {
        return new Tuple10<A,B,C,X,E,F,G,H,I,J>(
                this.val0, this.val1, this.val2, value, this.val4, this.val5, this.val6, this.val7, this.val8, this.val9);
    }
    
    public <X> Tuple10<A,B,C,D,X,F,G,H,I,J> setAt4(final X value) {
        return new Tuple10<A,B,C,D,X,F,G,H,I,J>(
                this.val0, this.val1, this.val2, this.val3, value, this.val5, this.val6, this.val7, this.val8, this.val9);
    }
    
    public <X> Tuple10<A,B,C,D,E,X,G,H,I,J> setAt5(final X value) {
        return new Tuple10<A,B,C,D,E,X,G,H,I,J>(
                this.val0, this.val1, this.val2, this.val3, this.val4, value, this.val6, this.val7, this.val8, this.val9);
    }
    
    public <X> Tuple10<A,B,C,D,E,F,X,H,I,J> setAt6(final X value) {
        return new Tuple10<A,B,C,D,E,F,X,H,I,J>(
                this.val0, this.val1, this.val2, this.val3, this.val4, this.val5, value, this.val7, this.val8, this.val9);
    }
    
    public <X> Tuple10<A,B,C,D,E,F,G,X,I,J> setAt7(final X value) {
        return new Tuple10<A,B,C,D,E,F,G,X,I,J>(
                this.val0, this.val1, this.val2, this.val3, this.val4, this.val5, this.val6, value, this.val8, this.val9);
    }
    
    public <X> Tuple10<A,B,C,D,E,F,G,H,X,J> setAt8(final X value) {
        return new Tuple10<A,B,C,D,E,F,G,H,X,J>(
                this.val0, this.val1, this.val2, this.val3, this.val4, this.val5, this.val6, this.val7, value, this.val9);
    }
    
    public <X> Tuple10<A,B,C,D,E,F,G,H,I,X> setAt9(final X value) {
        return new Tuple10<A,B,C,D,E,F,G,H,I,X>(
    ...
    public Tuple9<A,B,C,D,E,F,G,H,I> removeFrom9() {
